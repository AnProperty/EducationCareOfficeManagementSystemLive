...
const CreateStudent = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        axios.post(`${process.env.REACT_APP_API_BASE_URL}/receptionist/add-student`, formData)
            .then(result => {
                console.log(result);
                Swal.fire({
                    position: "top-end",
                    ...
                    <div className="form-box">
                        <div className="form-row">
                            <div className="form-group">
                                ...
                                <input type="text" required='true' id="studentId" name='studentId' onChange={handleChange} />
                            </div>
                            <div className="form-group">
                                <label htmlFor="fullName">Full Name</label>
                                <input type="text" id="fullName" name='fullName' required='true' onChange={handleChange} />
                            </div>
                        </div>
                        <div className="form-row">
                            <div className="form-group">
