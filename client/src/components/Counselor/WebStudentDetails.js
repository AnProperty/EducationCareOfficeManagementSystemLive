                    ...
                    {counselorStudent?.map((item, index) => {
                        return (
                            ...
                            <CTableRow v-for="item in tableItems" key={index} className='text-center'>
                                ...
                                <CTableDataCell>
                                    <Link to={`/counselor/web-student-details/${item.studentId}`} state={{ item: item }}><button className="button btn btn3">More Info</button></Link>
                                </CTableDataCell>
                            </CTableRow>
...
export default WebStudentDetails;